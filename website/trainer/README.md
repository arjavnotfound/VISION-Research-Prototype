...
Hopefully this will power a ["tongue as joystick"](https://github.com/1j01/vision/issues/116) feature in Vision, opening up the possibility of playing many more types of games, scrolling webpages more easily, and more.
...
- Consent form / contributor license agreement, possibly with two tiers (V.I.S.I.O.N. and non-commercial use vs. commercial/general use, or dividing along the lines of intent, assistive technology and maybe research vs. general use); could generate a license file in the dataset folder
...
Low impact:
- Coupling to private Vision internals: could extend the public API
