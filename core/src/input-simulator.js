...
// Pointer event simulation logic should be built into vision in the future.
...
export const VISION_POINTER_ID = 1234567890;

export class InputSimulator {
	pointerId = VISION_POINTER_ID;
	buttonStates = {
		0: false,
		1: false,
		2: false,
	...
	showToast(message, position = this.simulatedMousePosition) {
		...
		toast.style.animation = "vision-fade-out 2s ease-in-out forwards 2s";
	...
	targetFromPoint(x, y) {
		const skip = ".vision-click-through, .vision-click-through *";
